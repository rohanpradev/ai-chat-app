...
export function ErrorDisplay({ onRetry, onClear }: Readonly<ErrorDisplayProps>) {
  return (
    <div className="flex items-start gap-3 p-4 border border-red-200 rounded-lg bg-red-50 dark:bg-red-950/20 dark:border-red-800">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-sm text-red-700 dark:text-red-300 mb-3">
          The assistant could not finish that response. Please retry or start a new message.
        </div>
