...
Security-sensitive transitive dependencies are pinned exactly in the root overrides. Those pins must still clear the normal 72-hour release-age gate unless an emergency patch receives explicit maintainer review.
