...
const assistantMessageNeedsReasoningContext = (
...
export const transformPrompt = async (
  message: UIMessage[],
  ...
  const preserveReasoning = messages.some(
    assistantMessageNeedsReasoningContext,
  );
